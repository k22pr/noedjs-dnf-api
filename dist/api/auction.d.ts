 ...
 */
export declare const itemName: (itemName: string, params: any, query: any) => any;
/**
 ...
 * @param {object} query q에 해당하는 값입니다.
 */
export declare const itemId: (itemId: string, params: any, query: any) => any;
/**
 * 경매장에 등록된 경매장번호로 받아옵니다.
 *
 * @param {Number} auctionNo 검색할 경매장 번호입니다.
 */
export declare const no: (auctionNo: string) => any;
